	...
	return (
		<div className={styles.main}>
			...
			<div className={styles.information}>
				...
				languages. Therefore, many schools and universities teach Interlingua as a way of teaching other Romance
				languages more easily, and Interlingua has been embraced by parts of the scientific community. <br></br>{' '}
				<br></br>
				Despite its increasing popularity, Interlingua is not supported by online translation tools such as Google
				Translate. The purpose of this research project is to bridge this gap, by creating the first computer
				program that can translate text between English and Interlingua. The hope was that the translation tool
				would act as a valuable educational resource to Interlingua learners, and it might spread awareness of
